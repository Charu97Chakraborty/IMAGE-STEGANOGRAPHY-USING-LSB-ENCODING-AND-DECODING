...
Status read_and_validate_encode_args(char *argv[], EncodeInfo *encInfo)
{
    ...
    {
        printf("Please mention image file correctly Eg:beautiful.bmp\n");
        // returns failure
        return e_failure;
    }
    ...
    {
        printf("Please mention secret file correctly Eg:secret.txt\n");
        // returns failure
        return e_failure;
    }
    ...
    else
    {
        ...
        printf("Output filename not mentioned / mentioned without .bmp extension. Creating stego.bmp as default\n");
...
Status do_encoding(EncodeInfo *encInfo)
{
    ...
    {
        printf("Faild to encode secret file size\n");
    }
